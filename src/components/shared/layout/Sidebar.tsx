...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-border/50 bg-white/55 dark:bg-white/3 backdrop-blur-lg transition-transform duration-300 md:static md:translate-x-0",
          ...
          {menuItems.map((item) => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    "group relative flex items-center gap-3 rounded-md px-3.5 py-2.5 text-sm font-medium transition-all duration-300",
                    isActive
